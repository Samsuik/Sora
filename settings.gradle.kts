...
if (!file(".git").exists()) {
    val errorText = """
        ...
        =====================[ ERROR ]=====================
         The Sora project directory is not a properly cloned Git repository.
         
         In order to build Sora from source you must clone
...
for (name in listOf("sora-api", "sora-server")) {
